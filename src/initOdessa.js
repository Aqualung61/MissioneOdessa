...
const tableNames = ['Azioni', 'Interazioni', 'Introduzione', 'LessicoSoftware', 'Lingue', 'Luoghi', 'LuoghiLogici', 'Oggetti', 'Piattaforme', 'Software', 'TerminiLessico', 'TipiLessico', 'VociLessico'];
