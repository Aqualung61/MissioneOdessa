...
**Versione 1.3.4** - Adventure testuale con backend Node.js/Express, frontend statico e API REST basata su dati JSON statici.
...
- **Versione attuale: 1.3.4** (18 gennaio 2026)
