...
> - `index.html`, `web/odessa_intro.html`, `web/odessa_main.html`: **nessun blocco `<script>...</script>` inline** (solo script esterni).
...
|---|---|---|---|---|---|
| `script-src` | Caricamento ed esecuzione script (inline e file) | Nessuna inline `<script>...</script>` nei file principali | Policy già compatibile con `script-src 'self'` | Nessun intervento richiesto (ok così) | `index.html`, `web/odessa_intro.html`, `web/odessa_main.html` |
...
Nota: dopo il refactor (11 gennaio 2026) `index.html` e `web/odessa_intro.html` non contengono più script inline.
